...
if __name__ == "__main__":
    ...
    for data in ("sw", "card", "sim"):
        for bounds in ("known", "knownre", "geom", "geom1", "geom2", "geom3", "geom4", "const1", "const2", "const3", "const4", "template01", "template10", "template30", "templatem01", "templatem10", "templatem30"):
